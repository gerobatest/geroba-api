...
let modeTravaux = require('../models/modeTravaux.model'); //pour exiger le model 
...
router.route('/').get((req, res) =>{
    modeTravaux.find() // obtenir les donnée depuis la base de données
...
router.route('/add').post((req, res) => { //une requete Post 
    ...
    const newModeTravaux = new modeTravaux ({
        para1, 
        para2
    });
