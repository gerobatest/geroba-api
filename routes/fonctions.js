...
let fonctions = require('../models/fonctions.model'); //pour exiger le model 
...
router.route('/').get((req, res) =>{
    fonctions.find() // obtenir les donnée depuis la base de données
...
router.route('/add').post((req, res) => { //une requete Post 
    ...
    const newFonctions = new fonctions({
        para1, 
        para2, 
        para3, 
        para4, 
